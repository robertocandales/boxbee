...
const SmallerCards = ({ item, index }) => {
    return (
        <InnerCard backgroundColor={item.check ? colors.WHITE : colors.GRAY} key={index} boxShadow={item.check} >
            <IconCard>
            ...
            {item.uploadList ? (<AroundUpButton> <UploadButton /></AroundUpButton>) : null}
