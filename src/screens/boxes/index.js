...
import { WrapperCard, InnerCard, TitleCard, Paragraph, Title, CheckIcon, IconCard, CardBut } from './styles';
    ...
    return (
      ...
      eos tempore. Itaque obcaecati corrupti non suscipit tempora nostrum?{' '}
            <WrapperCard>
                ...
                <InnerCard>
                    <IconCard><img src={iconCard} alt="" srcset="" /></IconCard>
                    <CheckIcon><img src={checkedimage} alt="" srcset="" /></CheckIcon>
